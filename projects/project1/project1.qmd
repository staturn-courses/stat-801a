...
Complete each of the following problems using the provided Quarto template. Your code must be reproducible, but you are free to use any R packages that you would like (i.e., I can get the same output file by rendering your Quarto file). Submit your completed Quarto file and the rendered PDF file to Canvas.
