...
Complete each of the following problems using the provided Quarto template (on Canvas). Your code must be reproducible, but you are free to use any R packages that you would like (i.e., I can get the same output file by rendering your Quarto file). For each problem, include your code, output, and a brief written interpretation of your results. Submit your completed Quarto file and the rendered PDF file to Canvas.
